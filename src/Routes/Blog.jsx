    ...
    return (
      <div className="blog">
        ...
        <div className="toop">
          ...
          <img className="bgtop"  src="https://i.pinimg.com/originals/45/14/c6/4514c6e55c3014fe16072840dcdae308.gif" alt="poza"></img>         
          </div> 
        ...
        <img className="photod" src="https://i.pinimg.com/564x/37/52/1a/37521a8088a35fc24ccd44de809efe14.jpg" alt="poza"></img>
        </Link>
        </div>
        ...
        <img className="photoa" src="https://i.pinimg.com/564x/13/94/d6/1394d691537b78dba640a7f0c060ad76.jpg" alt="poza"></img>
        </Link>
        </div>
        </div>
